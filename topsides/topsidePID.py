...
"""
def runRotationLockPID(cPitch, cRoll, cYaw):
    pch = runPitchPID(float(cPitch), True)
    rl = runRollPID(float(cRoll), True)
    ...
    thrusterData = {
        ...
        "aft-port-vert":  (pch+rl) * THRUSTER_ADJ,
        "aft-star-vert":  (pch-rl) * THRUSTER_ADJ,
        "fore-port-horz": -yw * THRUSTER_ADJ,
        "fore-star-horz": -yw * THRUSTER_ADJ,
        "aft-port-horz": yw * THRUSTER_ADJ,
        "aft-star-horz": yw * THRUSTER_ADJ,
